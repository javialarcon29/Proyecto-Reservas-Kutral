...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO reservas (id, nombre, telefono, email, contraseña, fecha_reserva, hora_entrada, num_comensales, motivo) VALUES ('$id_usuario', '$nombre', '$telefono', '$email', '$contraseña', '$fecha_reserva', '$hora_entrada', '$num_comensales', '$motivo')";
